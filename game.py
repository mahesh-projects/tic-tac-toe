...
if __name__ == "__main__":
    ...
    while True:
        ...
        display_board(board) #Display an empty board
        ...
        while not full_board_check(board):
            print('game on')
            if win_check(board,'X'): #Break if player with X mark has won
                print("Player with 'X' marker won!")
                break
            elif win_check(board,'O'): #Break if player with O mark has won
